...
def capture_image(camera_source=0):
    cap = cv2.VideoCapture(camera_source)  # Use the specified camera source
    ...
    if ret:
        ...
        st.error("Failed to capture image from camera. Make sure your webcam is enabled.")
        return None
